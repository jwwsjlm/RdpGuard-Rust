...
```powershell
git tag -a v0.4.1 -m "RdpGuard v0.4.1"
git push origin main v0.4.1
```

Release 包：

- `RdpGuard-Rust-v0.4.1-windows-x64.zip`
- `RdpGuard-Rust-v0.4.1-windows-arm64.zip`
- `RdpGuard-Rust-v0.4.1-windows-x86.zip`
...
```powershell
Get-FileHash .\RdpGuard-Rust-v0.4.1-windows-x64.zip -Algorithm SHA256
...
```powershell
gh attestation verify .\RdpGuard-Rust-v0.4.1-windows-x64.zip --repo jwwsjlm/RdpGuard-Rust
```
